 ...
 This will deploy two artifacts, target/aggregator.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/aggregator.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/aggregator.war

 To undeploy the application, run:

  ./asadmin undeploy aggregator
